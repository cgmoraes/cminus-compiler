...
static const char *const yytname[] =
{
  ...
  "DCOLCH", "ECHAVE", "DCHAVE", "RECEBE", "ID", "NUM", "ACOM", "ERROR",
  "$accept", "programa", "decl_lista", "decl", "var_decl", "fun_decl",
  "params", "param_lista", "tipo_espec", "param", "comp_decl",
